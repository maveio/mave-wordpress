...
Uploads use short-lived JWTs generated by WordPress. With no upload target, the
plugin uses the space identified by the API key; a space id or collection id can
be configured explicitly. Public space hashes are not accepted as targets.
